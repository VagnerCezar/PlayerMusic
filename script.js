...
const Chopin = {
    songName: 'Nocturne No. 2 in E flat Major, Op. 9,2',
    artist: 'Frédéric_Chopin',
    file: 'Frédéric_Chopin',
    liked: false,
}
...
const originalPlaylist = JSON.parse(localStorage.getItem('playlist')) ?? [shootToThrill, aceOfSpades, Chopin] ;
...
song.addEventListener('timeupdate', uptadeProgress);
